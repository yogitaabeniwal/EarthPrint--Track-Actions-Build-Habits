        ...
        <main className="calculator-main">
          ...
          <div className="text">
            <div className="description">
              ...
              <p>
                Default values are the averages for an adult. Enter values for your personal carbon footprint, not
                ...
                <div className="home1">
                  ...
                  <FormControl variant="filled" sx={{ m: 1, minWidth: 120 }}>
                    ...
                    >
                      ...
                      <MenuItem value={'Cool'}>Rainy</MenuItem>
                  ...
                  <Box sx={{ m: 1, width: 300 }}>
                    <label>Average Time in Shower (Minutes)</label>
                    <Slider
                      sx={{
                        color: '#2C82B3',
                        margin: '40px 0 15px 0',
                  ...
                  <Box sx={{ m: 1, width: 300 }}>
                    <label>Average Flushes Per Day</label>
                    <Slider
                      sx={{
                        color: '#2C82B3',
                        margin: '40px 0 15px 0',
                  ...
                  <Box sx={{ m: 1, width: 300 }}>
                    <label>Bottles of Water Per Week</label>
                    <Slider
                      sx={{
                        color: 'green',
                        margin: '40px 0 15px 0',
